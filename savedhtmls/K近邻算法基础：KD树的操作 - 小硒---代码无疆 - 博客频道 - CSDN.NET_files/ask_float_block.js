...
(function(){
    $(function(){
        ...
        if(window.quickReplyflag) {
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-appcode-float-block'  title='APP二维码' style='top:"+(back_top_value-166)+"px'><span id='appcode-close'></span></a><a id='com-app-float-block' href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-82)+"px'></a>"+
                "<a id='com-quick-reply'  title='快速回复' style='top:"+(back_top_value-41)+"px'></a><a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a> </div>";
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-appcode-float-block'  title='APP二维码' style='top:"+(back_top_value-248)+"px'><span id='appcode-close'></span></a><a id='com-app-float-block'  href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-164)+"px'></a>"+
            ...
            var float_ask_img="<div data-mod='popu_64' class='tracking-ad' chg-blk='0' ><a id='com-appcode-float-block'  title='APP二维码' style='top:"+(back_top_value-123)+"px'><span id='appcode-close'></span></a><a id='com-app-float-block'   href='http://www.csdn.net/app/' title='APP下载' style='top:"+(back_top_value-41)+"px'></a>"+
                "<a id='com-d-top-a'  style='top:"+back_top_value+"px' title='返回顶部' onclick='' ></a></div>";
        }
